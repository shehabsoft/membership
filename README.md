...
To build the final jar and optimize the membership application for production, run:
...
[service discovery and configuration with consul]: https://www.jhipster.tech/documentation-archive/v7.0.0-beta.1/microservices-architecture/#consul
