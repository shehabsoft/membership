package org.emu.membership.security.oauth2;
    ...
    private OAuth2AuthorizedClient getTestOAuth2AuthorizedClient(boolean accessTokenExpired) {
        return new OAuth2AuthorizedClient(
            ClientRegistration
                ...
                .authorizationUri("http://192.168.5.86/auth/realms/myRealm/protocol/openid-connect/auth")
                .tokenUri("https://192.168.5.86/auth/realms/myRealm/protocol/openid-connect/token")
                .build(),
            "sub",
