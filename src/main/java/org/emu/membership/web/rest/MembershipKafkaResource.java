...
@RestController
@RequestMapping("/api/membership-kafka")
public class MembershipKafkaResource {

    private final Logger log = LoggerFactory.getLogger(MembershipKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public MembershipKafkaResource(KafkaProperties kafkaProperties) {
